...
class AppTexts {
  ...
  static String firstMainWord = "WELL";
  static String secondaryMainWord = "COME";
  static String welcome = "CUT FIT";
  ...
  static String signUpDescription =
      "We're excited to help you reach your fitness goals and support you on your journey to a healthier you.";
